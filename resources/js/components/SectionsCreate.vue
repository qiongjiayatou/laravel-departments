<template>
  <div>
    <div v-if="success" ref="alert" class="alert alert-success">Successfully created!</div>
    ...
    >
      <div class="form-group">
        ...
        <span v-if="form.errors.has('name')" class="invalid-feedback d-inline" role="alert">
      ...
      <div class="form-group">
        ...
        <span v-if="form.errors.has('description')" class="invalid-feedback d-inline" role="alert">
      ...
      <div class="custom-file form-group">
        ...
        <span v-if="form.errors.has('logo')" class="invalid-feedback d-inline" role="alert">
